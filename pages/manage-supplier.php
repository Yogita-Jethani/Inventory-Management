                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <form action="http://<?php echo BASE_SERVER ; ?>/erp/pages/scripts/supplier/edit.php" method="POST" id="manage_supplier_validations">
                                                    <div class="form-body">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="http://localhost/erp/pages/scripts/supplier/delete.php" method="POST">
                                                <input type="text" id="recordID" name="supplier_id">
...
<![endif]-->
        ...
        <script src="../assets/pages/scripts/manage_supplier_validate.js"></script>
