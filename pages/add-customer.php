...
<?php
    ...
    {   if($_GET['q'] == 'success')
        ...
        else if ($_GET['q'] == 'error')
        {
            ...
            <button class='close' data-close='alert'></button> Customer 
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button type="submit" name="add_customer" class="btn green">Add Customer</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<![endif]-->
    ...
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
        ...
        <script src="../assets/pages/scripts/add_customer_validate.js"></script>
