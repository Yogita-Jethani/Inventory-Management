                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <form action="http://<?php echo BASE_SERVER ; ?>/erp/pages/scripts/customer/edit.php" method="POST" id="manage_customer_validations">
                                                    <div class="form-body">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                       <form action="http://localhost/erp/pages/scripts/customer/delete.php" method = "POST">
                                           <input type="text" id="recordID" name="customer_id">
...
<![endif]-->
    ...
    <script src="../assets/pages/scripts/manage_customer_validate.js"></script>
